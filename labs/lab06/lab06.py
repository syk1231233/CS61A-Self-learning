...
class BankAccount(Transaction):
    ...
    def deposit(self, amount):
        ...
        """
        t=Transaction(next(self.index),self.balance,self.balance)
        self.transactions.insert(len(self.transactions),t)
        self.balance = self.balance + amount
        self.transactions[len(self.transactions)-1].after=self.balance
        return self.balance
