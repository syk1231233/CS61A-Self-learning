...
def make_test_dice(*outcomes):# an argument with * means this function can receive endless arguments and bind them into a tuple
    ...
    for o in outcomes:# in the for loop,the variable o can represtent any element in 'outcomes'
        assert type(o) == int and o >= 1, 'Outcome is not a positive integer'
    index = len(outcomes) - 1# in the tuple, the first elements's index is 0
    def dice():
        nonlocal index
